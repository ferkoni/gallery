...
export function DownloadAlbumButton({ albumId, albumName, disabled }: Props) {
  ...
  return (
    <button
      ...
      className="text-sm px-3 py-2 rounded-lg border border-control text-secondary hover:bg-hover disabled:opacity-40 disabled:cursor-not-allowed transition-colors cursor-pointer"
    >
