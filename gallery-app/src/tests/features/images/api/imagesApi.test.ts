...
const image: Image = {
  ...
  url: 'https://my-bucket.s3.us-east-1.amazonaws.com/images/uuid/photo.jpg?sig=abc',
  thumbnail_url: 'https://my-bucket.s3.us-east-1.amazonaws.com/images/uuid/photo.thumb.webp?sig=abc',
};
