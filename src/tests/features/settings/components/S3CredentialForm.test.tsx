...
describe("S3CredentialForm", () => {
  ...
  it("disables submit button and shows 'Adding...' when isPending", () => {
    render(<S3CredentialForm {...defaultProps} isPending={true} />);
  ...
  it("disables delete button and shows 'Deleting...' when isDeleting", () => {
    render(<S3CredentialForm {...defaultProps} isDeleting={true} />);
