...
class Album < ApplicationRecord
  ...
  # ?q= on the index, reached through Api::AlbumsController#apply_filters. A name substring
  # is the whole of it: there is no AI tier for folders, and nothing else about a folder is
  # worth matching on.
